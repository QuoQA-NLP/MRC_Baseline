...
from transformers.models.bart.modeling_bart import BartEncoder, BartPretrainedModel, BartModel
...
class BartForV2QuestionAnswering(BartPretrainedModel):
    ...
    ) -> Union[Tuple, QuestionAnsweringV2ModelOutput]:
        r"""
